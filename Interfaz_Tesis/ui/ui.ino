...
void setup() {
  ...
  lv_label_set_text(ui_porcentajeLabel, initial_brightness_buffer);
...
void loop() {
  ...
  if (Comms::bleEnabled && Comms::bleConnected && !Sensor::ErrorSCD) {
    ...
    String datosTX = String(Sensor::co2Concentration) + ";" + String(Sensor::CH4_ppm) + ";" + String(Sensor::temperature) + ";" + String(Sensor::relativeHumidity);
